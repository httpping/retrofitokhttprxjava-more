...
public abstract class BaseMvpFragment<P> extends Fragment {
    protected Context mContext; // 上下文
    protected View mRoot;   // 基础root
    protected Bundle mBundle; // 参数
    protected LayoutInflater mInflater; // layout
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TAG = "aiu"+  getClass().getSimpleName();
